...
/**
 * The HomeScreen component is the main screen of the app, displaying a list of projects,
 * a timer for tracking project time, and controls for switching projects and starting/stopping the timer.
 *
 * @component
...
export default function HomeScreen() {
  ...
  /**
   * Calculates the elapsed time for the currently selected project.
   */
  ...
  /**
   * Starts the timer for the currently selected project.
   */
  const startTimer = () => {
    dispatch(
      setTimer({
  ...
  /**
   * Stops the timer for the currently selected project.
   */
  ...
  /**
   * Handles switching to a different project.
   *
   * @param {string} newProjectTitle - The title of the new project.
   * @param {number} newProjectId - The ID of the new project.
   */
